...
const tele_op_t *tele_ops[E_OP__LENGTH] = {
    ...
    &op_LV_PRE, &op_LV_RES, &op_LV_POS, &op_LV_L_ST, &op_LV_L_LEN, &op_LV_L_DIR, &op_LV_CV,
    &op_CY_PRE, &op_CY_RES, &op_CY_POS, &op_CY_REV, &op_CY_CV,
    &op_CR_PRE, &op_CR_ACT, &op_CR_DIR, &op_CR_CHAIN, &op_CR_CHAIN, &op_CR_LOOP,
    &op_MID_SHIFT, &op_MID_SLEW, &op_ARP_STY,
